...
[data-nav]{display:none;position:fixed;inset:0;background:var(--color-cream);padding:5rem var(--pad);transform:translateY(-100%);transition:transform .3s ease;z-index:40;visibility:hidden;pointer-events:none}
